...
hist(Data2[,2],xlab="Number of Steps", main= "Number of Steps Taken Daily",col = "blue")
options(digits=2)
...
plot(Data3[,1],Data3[,2],type="l", xlab="Intervals", ylab="Average Number of Steps Taken",main="Average Number of Steps Across All Days",col="red")
...
Data2 <- ddply(Data, c("date"), summarise,sum=sum(steps))
hist(Data2[,2],xlab="Number of Steps", main= "Number of Steps Taken Daily",col = "green")
sprintf("%.2f",mean(Data2[,2],na.rm=TRUE))
sprintf("%.2f",median(Data2[,2],na.rm=TRUE))
```
...
plot(weekday_data[,1],weekday_data[,3],type = "l",col="blue",xlab="Intervals",ylab="Weekday Average Number of Steps Taken")
plot(weekend_data[,1],weekend_data[,3],type="l",col="red",xlab="Intervals",ylab="Weekend Avergae Number of Steps Taken")
```
